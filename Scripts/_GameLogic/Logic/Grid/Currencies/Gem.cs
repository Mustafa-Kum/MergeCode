...
{
    public sealed class Gem : GridObject, IObjectClickAction
    {
        ...
        public void Execute()
        {
            ...
            EventManager.ProductEvents.ProductCurrencyRewardCollect?.Invoke(CurrencyType.Gem);
            
            EventManager.Resource.CurrencyCollected?.Invoke(CurrencyType.Gem, transform.position);
