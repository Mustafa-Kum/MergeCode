...
{
    public sealed class Coin : GridObject, IObjectClickAction
    {
        ...
        public void Execute()
        {
            ...
            EventManager.ProductEvents.ProductCurrencyRewardCollect?.Invoke(CurrencyType.Coin);

            EventManager.Resource.CurrencyCollected?.Invoke(CurrencyType.Coin, transform.position);
